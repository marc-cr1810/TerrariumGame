...
#define TE_PROFILE_BEGIN_SESSION(name, filepath) ::Terrarium::Instrumentor::Get().BeginSession(name, filepath)
#define TE_PROFILE_END_SESSION() ::Terrarium::Instrumentor::Get().EndSession()
#define TE_PROFILE_SCOPE_LINE2(name, line) constexpr auto fixedName##line = ::Terrarium::InstrumentorUtils::CleanupOutputString(name, "__cdecl ");\
												   ::Terrarium::InstrumentationTimer timer##line(fixedName##line.Data)
